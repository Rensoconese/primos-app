...
// const { withSentryConfig } = require("@sentry/nextjs"); // Temporalmente deshabilitado por conflictos con Rollup
...
// Temporalmente exportar nextConfig directamente sin Sentry para evitar errores de Rollup
