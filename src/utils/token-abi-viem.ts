...
/**
 * ABI para el token ERC1155 Fire Dust en formato viem
 */
export const FIRE_DUST_ABI = parseAbi([
...
/**
 * Tipo para el ABI del token Fire Dust
 */
export type FireDustAbi = typeof FIRE_DUST_ABI
